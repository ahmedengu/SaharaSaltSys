...
google.maps.__gjsload__('drawing', function (_) {
    ...
    _.t(ww, _.C);
    _.Ld(ww.prototype, {map: _.Ei, drawingMode: _.ji});
    _.Gc.google.maps.drawing = {
        DrawingManager: ww,
        OverlayType: {
            MARKER: "marker",
            POLYGON: "polygon",
...
google.maps.__gjsload__('places', function (_) {
    var Fw = function (a, b) {
        try {
            _.gd(window.HTMLInputElement, "HTMLInputElement")(a)
        } catch (c) {
            if (_.Zc(c), !a)return
        }
    ...
    _.t(Fw, _.C);
    Fw.prototype.setTypes = _.Kd("types", _.id(_.gi));
    Fw.prototype.setComponentRestrictions = _.Kd("componentRestrictions", _.md(_.cd({country: _.kd([_.gi, _.id(_.gi)])}, !0)));
    _.Ld(Fw.prototype, {place: null, bounds: _.md(_.$d)});
    Iw.prototype.getPlacePredictions = function (a, b) {
        _.G("places_impl", (0, _.p)(function () {
            this.b.getPlacePredictions(a, b)
        }, this))
    };
    Iw.prototype.getPredictions = Iw.prototype.getPlacePredictions;
    Iw.prototype.getQueryPredictions = function (a, b) {
        _.G("places_impl", (0, _.p)(function () {
    ...
    _.k.search = Mw.prototype.nearbySearch;
    ...
    _.t(Nw, _.C);
    _.Ld(Nw.prototype, {places: null, bounds: _.md(_.$d)});
    _.Gc.google.maps.places = {
        PlacesService: Mw,
        PlacesServiceStatus: {
            OK: _.ha,
            UNKNOWN_ERROR: _.ka,
